...
export const generateSpinNumbers = (selectedBalance: string, selectedSpinType: string): string[] => {
  console.log('generateSpinNumbers çağrıldı:', { selectedBalance, selectedSpinType });
